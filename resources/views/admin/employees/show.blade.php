...
<div class="row g-3">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body text-center">
                ...
                <div class="d-grid gap-2">
                    <span class="badge bg-{{ $employee->status == 'active' ? 'success' : 'danger' }} p-2">
                ...
                <div class="text-start">
                    ...
                    <p><strong><i class="fas fa-phone me-2"></i>Phone:</strong> {{ $employee->phone ?? 'N/A' }}</p>
                    <p><strong><i class="fas fa-building me-2"></i>Department:</strong> {{ $employee->department->name ?? 'N/A' }}</p>
                    <p><strong><i class="fas fa-briefcase me-2"></i>Designation:</strong> {{ $employee->designation->name ?? 'N/A' }}</p>
                    <p><strong><i class="fas fa-user-tag me-2"></i>Role:</strong> {{ $employee->roles->first()?->name ?? 'No Role' }}</p>
                    <p><strong><i class="fas fa-user me-2"></i>Manager:</strong> {{ $employee->manager->name ?? 'N/A' }}</p>
                    <p><strong><i class="fas fa-calendar-plus me-2"></i>Joined:</strong> {{ $employee->created_at->format('M d, Y') }}</p>
                </div>
    ...
    <div class="col-md-8">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold">{{ $employee->attendances->count() }}</h2>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold">{{ $employee->leaveRequests->count() }}</h2>
                            ...
                            <tbody>
                                @foreach($employee->attendances->take(5) as $attendance)
                                    <tr>
                                        ...
                                        <td>{{ $attendance->working_minutes ? floor($attendance->working_minutes / 60) . 'h ' . ($attendance->working_minutes % 60) . 'm' : 'N/A' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-transparent">
                <h6 class="mb-0"><i class="fas fa-clipboard-list me-2"></i>Recent Leaves</h6>
            </div>
            <div class="card-body p-0">
