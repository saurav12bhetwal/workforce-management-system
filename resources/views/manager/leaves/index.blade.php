...
@section('page-title', 'Team Leaves')
...
<div class="row g-3">
    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <form method="GET" action="{{ route('manager.leaves.index') }}" class="row g-3 align-items-end">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('manager.leaves.index') }}" class="btn btn-secondary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="approve-form-{{ $leave->id }}" 
                                                  action="{{ route('manager.leaves.approve', $leave->id) }}" 
                                                  method="POST" style="display: none;">
                                                @csrf
                                            </form>

                                            <form id="reject-form-{{ $leave->id }}" 
                                                  action="{{ route('manager.leaves.reject', $leave->id) }}" 
                                                  method="POST" style="display: none;">
                                                @csrf
