...
@section('content')
    <div class="card shadow-sm border-0">
        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-info">Code: {{ $employee->employee_code }}</span>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="form-control-static text-muted">{{ $employee->created_at->format('M d, Y H:i') }}
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $.each(data, function(key, value) {
                                    var selected = value.id == selectedDesignation ?
                                        'selected' : '';
                            ...
                            error: function() {
                                designationSelect.find('option:disabled').remove();
                                designationSelect.append(
                                    '<option value="" disabled>Error loading designations</option>'
                                    );
                            }
                        });
                    }
