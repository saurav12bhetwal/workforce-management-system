...
<div class="row g-3">
    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <form method="GET" action="{{ route('manager.attendance.index') }}" class="row g-3 align-items-end">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('manager.attendance.index') }}" class="btn btn-secondary btn-sm">
                            ...
                            <tbody>
                                @foreach($attendances as $key => $attendance)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('manager.attendance.show', $attendance->id) }}" 
