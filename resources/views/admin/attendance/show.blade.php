        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                        ...
                        <div class="p-3 bg-light rounded-3">
                            ...
                            @if($attendance->check_in)
                                ...
                                <small class="text-muted">
                                    {{ $attendance->check_in_location ?? 'No location' }}
                                </small>
                            @else
                    ...
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded-3">
                            ...
                            @if($attendance->check_out)
                                ...
                                <br>
                                <small class="text-muted">
                                    {{ $attendance->check_out_location ?? 'No location' }}
                                </small>
                            @else
                        ...
                        <div class="p-3 bg-light rounded-3">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <span class="text-muted small align-self-center">
                                    Lat: {{ $attendance->check_in_lat }}, Lng: {{ $attendance->check_in_lng }}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border-top pt-3 mt-3">
                    ...
                    <a href="{{ route('admin.attendance.employee-report', $attendance->user_id) }}" class="btn btn-info">
                        <i class="fas fa-user me-2"></i> View Employee Report
                    </a>
                </div>
            </div>
        </div>
